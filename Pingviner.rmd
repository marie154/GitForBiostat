...
Funksjonene summarise() og summarise_each() oppsummerer data til en enkelt rad med verdier. Også fin å bruke med group_by() funksjonen, da oppsummeres datasettet per gruppe.
